...
<body class="text-tet">
    ...
    <div class="absolute left-72 w-3/4 py-5 px-16">
        <h1 class="text-3xl text-blue font-bold mt-32 font-[Montserrat]">Absen </h1>
        <div class="col-md-8 " style="margin-top: 10%;">
            <img src="{{ url_for('video_feed2') }}" width="100%" class="img-thumbnail">
        </div>
        <div>
        ...
        <a href="{{ url_for('home') }}">
            <button class="bg-blue text-white py-2 px-4 mt-1 rounded-xl w-fit mx-auto font-semibold">Akhiri
                Absen</button>
        </a>
    </div>
    <!-- custom alert -->
