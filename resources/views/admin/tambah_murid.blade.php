    ...
    <div class="absolute flex justify-center items-center text-bg-blue-dark top-20 left-64 h-4/5 w-4/5 ">
       ...
       class="w-3/5 h-4/5 rounded-xl shadow-card pt-7 px-10 bg-white">
           ...
           <div class="flex mt-2 items-center border-b-[2px] border-[#393939] w-full h-[5%]">
            ...
            <!-- inputan -->
           <form class="my-4 w-full h-1/2" action="/admin/data_kelas/tambah_murid" method="POST" enctype="multipart/form-data">
               @csrf
                       ...
                       <div class=" h-full">
                           ...
                           <div class="flex w-full h-1/2">
                               ...
                               <div class="flex items-center ">
                                   <a href="/admin/data_kelas/{{ $kelas->id }}" class="text-black border-black border-[1px] rounded mr-5 px-5 py-[4%] hover:scale-110 hover:bg-bg-blue-dark hover:text-white">Batal</a>
                               </div>
                           ...
                           <div class="flex justify-center  w-full h-1/3">
                               <p class="font-[quicksands] font-medium text-base text-[#595959]">Apakah anda yakin ingin menambahkan murid?</p>
                           </div>  
