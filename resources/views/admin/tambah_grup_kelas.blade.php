            ...
            <div class="md:w-1/2 h-full md:p-10 md:mt-0 mt-5">
                ...
                <form action="/admin/grup_kelas" method="post">
                    ...
                    <div class="border-[2px] border-[#2C3E50] rounded pl-3 lgs:w-4/5 w-full  flex">
                        <label
                            ...
                            for="x">ID</label>
                        <input id="x" name="chat_id" value="{{ old('chat_id') }}" placeholder="Chat ID Grup Telegram"
                    ...
                    <div class="mt-5">
                        ...
                        <input type="text" value="{{ old('nama_grup') }}" name="nama_grup" placeholder="Masukan Nama Grup"
                    ...
                    <input type="text" name="kelas" value="{{ old('kelas') }}" placeholder="Masukan Kelas"
                        class="p-1 font-[quicksands] font-medium lgs:w-4/5 w-full h-[30%] rounded mt-2 border-[2px] border-[#2C3E50]">
                    @error('kelas')
                        <small class="text-red-600 font-bold">{{ $message }}</small>
                    @enderror
                    ...
                    <input type="text" name="nama_walas" value="{{ old('nama_walas') }}" placeholder="Masukan Nama Wali Kelas"
                ...
                <div class="md:w-1/2  h-full">
                    ...
                    <div class="flex md:justify-end w-[full]">
                        <h1 class="font-[montserrat] font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl">Buat Kelas Baru</h1>
                    </div>
