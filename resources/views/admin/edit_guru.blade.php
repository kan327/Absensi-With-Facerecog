       ...
       <form class="mt-2 w-full h-1/2" action="/admin/guru/{{ $gurus->id }}" method="POST">
        ...
        <!-- input data guru -->
            <div class="flex sm:flex-row flex-col">
               ...
               <div class="sm:w-1/2 sm:mr-5">
                    ...
                    <div class="flex">
                        <input name="name" placeholder="Nama Guru" type="text" class="font-bold pl-3 outline-none sm:w-[62%] w-[100%] mr-2 h-8 rounded-md border-solid border-[1px] border-[#2C3E50]" value="{{ $gurus->name }}">
                    ...
                    <input name="email" placeholder="Email Guru" type="email" class="font-bold pl-3 outline-none w-full h-8 rounded-md border-solid border-[1px] border-[#2C3E50]" value="{{ $gurus->email }}"><br>
                    @error('email')
                        <small class="text-red-500 font-bold">{{ $message }}</small>
                    @enderror
               </div>
               ...
               <!-- inputan kanan -->
                <div class="sm:w-1/2">
                    ...
                    <input name="nip" type="number" placeholder="NIP Guru" class="font-bold pl-3 outline-none w-full h-8 rounded-md border-solid border-[1px] border-[#2C3E50]" value="{{ $gurus->nip }}"><br>
                    @error('nip')
                        <small class="text-red-500 font-bold">{{ $message }}</small>
                    @enderror
                    ...
                    <input name="no_hp" placeholder="No Telepon Guru" type="number" class="font-bold pl-3 outline-none w-full h-8 rounded-md border-solid border-[1px] border-[#2C3E50]" value="{{ $gurus->no_hp }}"><br>
                    @error('no_hp')
                        <small class="text-red-500 font-bold">{{ $message }}</small>
                    @enderror
                </div>
        ...
        <div class="flex sm:flex-row flex-col">
            ...
            <div class="sm:w-1/2 sm:mr-5">
                ...
                <input name="username" placeholder="Username Guru" type="text" class="font-bold pl-3 outline-none w-full h-8 rounded-md border-solid border-[1px] border-[#2C3E50]" value="{{ $gurus->username }}"><br>
                @error('username')
                    <small class="text-red-500 font-bold">{{ $message }}</small>
                @enderror
            </div>
               ...
               <!-- inputan kanan -->
                    <div class="sm:w-1/2">
                        ...
                        <input name="password" type="password" placeholder="Password Guru" class="font-bold pl-3 outline-none w-full h-8 rounded-md border-solid border-[1px] border-[#2C3E50]" value="{{ $gurus->password }}"><br>
                        @error('password')
                            <small class="text-red-500 font-bold">{{ $message }}</small>
                        @enderror
                    </div>
               ...
               <div class="w-full mt-5 h-[5vh]">
                ...
                <button type="submit"
                class="font-[quicksands] min-w-[85px] font-semibold bg-[#2C3E50] text-white border-[2px] border-[#2C3E50] rounded w-[12%] h-full">Simpan
                </button>
                </div> 
