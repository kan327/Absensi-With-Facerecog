...
<body class="text-tet">
    ...
    <div class="absolute left-[11%] w-3/4 bg-white h-fit mt-32 ml-12 rounded-xl shadow-bxsd pb-12  ">
        <div class="border-b-blue border-2 w-10/12 mx-auto pb-4">
            ...
            <form method="POST" action="/admin/data_siswa/tambah_murid/simpan" enctype="multipart/form-data">
                @csrf
