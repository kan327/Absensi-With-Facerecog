...
//         document.body.innerHTML += '<div id="p2" class="animated-up fixed z-50 py-3 px-5 left-[75%] top-40 flex justify-between w-72 h-12 bg-red-600 rounded "><p class="text-white">Mohon lihat Pesan Diatas!</p><span class="material-symbols-outlined text-white">warning</span></div>'
...
//         }, 5000)
//     }else{
//         document.body.innerHTML += '<div id="p1" class="animated-up fixed z-50 py-3 px-5 left-[75%] top-20 flex justify-between w-72 h-12 '+color+' rounded "><p class="text-white">'+messege+'</p><span class="material-symbols-outlined text-white">'+icon+'</span></div>'
//         var box2 = document.getElementById('p1')
//         setTimeout(() => {
//             box2.classList.add("animated-down");
//         }, 4000)
