...
class AdminController extends Controller
{
    ...
    // search tanpa tanggal dengan ajax
    public function filter_date($tahun, $bulan)
    {
        $date_now = Carbon::now("Asia/Jakarta")->format("Y-m-d");
        $time_now = Carbon::now("Asia/Jakarta")->format("H:i:s");
        
        $data_jadwal = JadwalAbsen::where("tanggal", "like", "%$tahun-$bulan-%")->get();
    ...
    // search dengan tanggal dan ajax
    public function filter_tanggal($tahun, $bulan, $tanggal)
    {
        $date_now = Carbon::now("Asia/Jakarta")->format("Y-m-d");
        $time_now = Carbon::now("Asia/Jakarta")->format("H:i:s");
        
        $data_jadwal = JadwalAbsen::where("tanggal", "like", "%$tahun-$bulan-$tanggal%")->get();
